// ============================================================
// script.js - Explore World (Forest Emerald Final)
// Features: Fixed Mic, Real Earth, Zoom, AI Chatbot, Auto-count,
// Notifications, Real Images, Dark Mode, Digital Booking, 3D Animation
// ============================================================
...
const tours = [
    ...
    { id: 5, name: 'Varanasi Cultural Tour', price: 12999, desc: '3 days exploring the spiritual capital of India', category: 'cultural', region: 'india', img: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=400&h=400&fit=crop&auto=format', badge: 'popular', discount: 5, duration: '3 Days', rating: 4.7, reviews: 156 },
    { id: 6, name: 'Rishikesh Adventure', price: 16999, desc: '4 days of rafting, bungee jumping & yoga', category: 'adventure', region: 'india', img: 'https://images.unsplash.com/photo-1591018653367-7c1e27eb1b21?w=400&h=400&fit=crop&auto=format', badge: 'adventure', discount: 12, duration: '4 Days', rating: 4.8, reviews: 178 },
    { id: 7, name: 'Darjeeling Himalayan Tour', price: 21999, desc: '5 days of tea gardens & mountain views', category: 'mountain', region: 'india', img: 'https://images.unsplash.com/photo-1544413660-299165566b1d?w=400&h=400&fit=crop&auto=format', badge: 'luxury', discount: 8, duration: '5 Days', rating: 4.7, reviews: 98 },
    ...
    { id: 14, name: 'Paragliding in Bir Billing', price: 12999, desc: '3 days of paragliding & camping in the Himalayas', category: 'adventure', region: 'india', img: 'https://images.unsplash.com/photo-1600240644455-3edc55c375fe?w=400&h=400&fit=crop&auto=format', badge: 'adventure', discount: 15, duration: '3 Days', rating: 4.8, reviews: 156 },
    ...
    { id: 18, name: 'Hyderabad Culture', price: 7999, desc: '2 days of biryani, pearls & monuments of Hyderabad', category: 'city', region: 'india', img: 'https://images.unsplash.com/photo-1600096194534-95cf5ece04cf?w=400&h=400&fit=crop&auto=format', badge: 'budget', discount: 0, duration: '2 Days', rating: 4.6, reviews: 189 },
    ...
    { id: 22, name: 'Swiss Alps Adventure', price: 120000, desc: '7 days of snow-capped peaks & scenic trains', category: 'mountain', region: 'europe', img: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=400&h=400&fit=crop&auto=format', badge: 'adventure', discount: 15, duration: '7 Days', rating: 5.0, reviews: 245 },
...
document.getElementById('createAccountForm').addEventListener('submit', function(e) {
    ...
    safeSetJSON('exploreworld_account', accountData);
...
function getAIResponse(question) {
    ...
    if (/weather|mausam|temperature/i.test(q)) return "Check current weather at your destination using weather apps! 🌤️ Best time: Oct-March for India.";
...
// ============================================================
const languageText = {
    en: { home:'🏠 Home', about:'📖 About', tours:'✈️ Tours', offers:'🔥 Offers', profile:'👤 Profile', search:'Search destinations...' },
    hi: { home:'🏠 होम', about:'📖 हमारे बारे में', tours:'✈️ टूर', offers:'🔥 ऑफ़र्स', profile:'👤 प्रोफ़ाइल', search:'डेस्टिनेशन खोजें...' },
    gu: { home:'🏠 હોમ', about:'📖 અમારા વિશે', tours:'✈️ ટૂર્સ', offers:'🔥 ઑફર્સ', profile:'👤 પ્રોફાઇલ', search:'ડેસ્ટિનેશન શોધો...' }
};
...
function applyLanguage(lang) {
    ...
    const keys = ['home','about','tours','offers','profile'];
    nav.forEach((el, i) => { if (keys[i]) el.textContent = t[keys[i]]; });
...
function getNotifications() {
    return readJSON('exploreworld_notification_items', []);
}
...
function renderNotificationPanel() {
    ...
    if (!list) {
        ...
        list.className = 'notification-live-list';
...
function setupThemeToggle() {
    if (document.getElementById('ewThemeButton')) return;

    const button = document.createElement('button');
    button.id = 'ewThemeButton';
    button.className = 'ew-theme-button';

    const savedTheme = localStorage.getItem('exploreworldTheme');
    if (savedTheme === 'dark') {
...
// ============================================================
// DIGITAL TICKET BUTTONS
// ============================================================
document.getElementById('ewPrintTicket')?.addEventListener('click', function() {
    window.print();
});
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🌿 Explore World Loading - Forest Emerald');
    hideLoadingScreen();
    setupPasswordToggle();
    checkAccount();
    initSlider();
